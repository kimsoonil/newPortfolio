...
import { SKILL_CATEGORIES } from "@/app/(home)/_constants";

export default function Skills() {
  return (
    <section
      id="skills"
      className="py-20 bg-linear-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-slate-950/20 dark:via-slate-900/20 dark:to-slate-950/20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold bg-linear-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
              SKILLS
            </h2>
          </div>
